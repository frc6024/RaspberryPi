...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__cv_resize_fx = 2
        self.__cv_resize_fy = 2
        self.__cv_resize_interpolation = cv2.INTER_LINEAR

        self.cv_resize_output = None

        self.__cv_gaussianblur_src = None
        ...
        self.__hsl_threshold_hue = [44.676254014317074, 136.38226193372708]
        self.__hsl_threshold_saturation = [215.55755067643503, 255.0]
        self.__hsl_threshold_luminance = [169.69424679124955, 243.68599686606345]
    ...
    def process(self, source0):
        ...
        (self.cv_resize_output) = source0#self.__cv_resize(self.__cv_resize_src, self.__cv_resize_dsize, self.__cv_resize_fx, self.__cv_resize_fy, self.__cv_resize_interpolation)
